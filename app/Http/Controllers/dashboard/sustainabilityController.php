...
class sustainabilityController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        $data = SubMenu::where('tag', 'sustainability')->where('status', 1)->get();
    ...
    public function edit($id)
    {
        ...
        $route = "sustainability.send.edit";
        $icon = "far fa-edit";
        $menu  = Menu::all();
    ...
    public function store(Request $request)
    {
        ...
        if ($request->hasFile('image') && $request->file('image')->isValid()) {
            ...
            if ($update->id > 0) {
                return \Redirect::route('sustainability.add')->with(['icon' => 'success', 'message' => 'Dados Salvo']);
            } else {
                return \Redirect::route('sustainability.add')->with(['icon' => 'error', 'message' => 'Erro ao salvar']);
            }
        } else {
            ...
            if ($update->id > 0) {
                ...
                return \Redirect()->route('sustainability.add')->with(['icon' => 'error', 'message' => 'Erro ao Salvo']);
            }
        }
    }
