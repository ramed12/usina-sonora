...
class certificateController extends Controller
{
    ...
    {
        $page = "Galeria de Imagens - Certificações";
        $route = 'gallery.certificate';
        $gallery = 'certificate';

        $data = Images::where('gallery', 'certificate')->get();
    ...
    public function add()
    {
        $page = "Galeria de Imagens - Certificações";
        $action = 'Salvar';
        $route = "gallery.certificate.add";
        $route2 = "gallery.certificate";
        $gallery = 'certificate';
        $icon = "fas fa-plus";
    ...
    public function edit($id)
    {
        $page = "Galeria de Imagens - Certificações";
        $action = 'Editar';
        $route = "gallery.certificate.send.edit";
        $route2 = "gallery.certificate";
        $gallery = 'certificate';
        $icon = "fas fa-edit";
        $data = Images::find($id);
